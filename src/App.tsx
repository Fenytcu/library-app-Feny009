    ...
    <Router>
      ...
      <Routes>
        ...
        <Route element={<AdminRoute />}>
          ...
          <Route path="/admin/borrowed-list" element={<AdminBorrowedListPage />} />
          <Route path="/admin/user-list"     element={<AdminUserPage />} />
          <Route path="/admin/book-list"     element={<AdminBookListPage />} />
          <Route path="/admin/book-list/detail/:id" element={<AdminBookDetailPage />} />
          <Route path="/admin/book-list/create"     element={<AdminEditBookPage />} />
          <Route path="/admin/book-list/edit/:id"   element={<AdminEditBookPage />} />
